...
const CakesComponent = () => {
  ...
  const handleChange = async (event, index, cake) => {
    ...
    const selectedWeight = value || "500";
    const weightPriceMultiplier = weightMultiplier[selectedWeight] || 1;
                    ...
                    <div className="row justify-content-center">
                      {filteredCakes.length > 0 ? (
                        ...
                        <div className="col-12 text-center my-5">
                          <h5>No cakes available for the selected filters</h5>
                          <p>Please try different combination of Standard/Premium and Egg/Eggless</p>
                        </div>
                      )}
                    </div>
                    <div className="alert light-back mt-3">
                      ...
                      <span style={{ color: "white" }}>
                        <b>Note :</b>
                        <div >
                          <span>Customized cakes must be ordered 3 days prior.</span><br />
                          <span> For customized cakes please contact us.</span>
                        </div>
                      </span>
                    </div>
                    <div className="alert light-back mt-3">
